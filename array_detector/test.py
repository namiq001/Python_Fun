...
# Sözlər array
words = ["oglan", "peyser", "qehbe", "petux"]

# Sözün artıq göstərilmədiyinə əmin olmaq üçün bayraq
word_shown = False
chosen_word = ""
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        # Əgər söz artıq göstərilməyibsə, birini seçirik
        if not word_shown:
            chosen_word = random.choice(words)
            word_shown = True
        
        # Söz əlavə edirik
        cv2.putText(frame, chosen_word, (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 2)
